...
export default function AnnualReviewPage() {
  ...
  const { downloadAnnualReviewPDF } = useDownloadAnnualReviewPDF();
  ...
  if (!report) {
    return (
      <ReportContainer title="Annual Review">
        <Button variant="ghost" size="sm" className="gap-1 mb-4" onClick={() => router.push("/portal/reports/annual")}>
  ...
  return (
    ...
    >
      {/* Back link + Year Navigation */}
      <div className="flex items-center justify-between">
        <Button variant="ghost" size="sm" className="gap-1" onClick={() => router.push("/portal/reports/annual")}>
          <ChevronLeft className="h-4 w-4" />
          All Years
        </Button>
      </div>
