  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Envelopes",
          href: "/documents/envelopes",
          icon: FileSignature,
          tooltip: "DocuSign Envelopes",
          roles: [MD, RM, COORD],
        },
      ],
    },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          href: "/analytics/risk",
          icon: ShieldAlert,
          tooltip: "Risk Alerts & Health Forecasting",
          roles: [MD, RM],
        },
        {
        ...
        },
        {
          ...
          subItems: [
            ...
            { title: "Partner Scorecard", href: "/reports/partner-scorecard" },
            { title: "RM Portfolio", href: "/reports/rm-portfolio" },
            { title: "Escalation Log", href: "/reports/escalation-log" },
            { title: "Compliance Audit", href: "/reports/compliance-audit" },
            { title: "Schedules", href: "/reports/schedules" },
          ],
        },
        {
          title: "Surveys",
