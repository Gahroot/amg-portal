...
const priorityColors: Record<string, string> = {
  ...
  normal: "bg-blue-100/30 text-blue-700 dark:bg-blue-900 dark:text-blue-300",
  high: "bg-orange-100/30 text-orange-700 dark:bg-orange-900 dark:text-orange-300",
  urgent: "bg-red-100/30 text-red-700 dark:bg-red-900 dark:text-red-300",
};
