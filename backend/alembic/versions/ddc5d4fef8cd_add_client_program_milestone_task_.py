...
down_revision: Union[str, Sequence[str], None] = '04dc48f4efa6'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['assigned_rm_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['compliance_reviewed_by'], ['users.id'], ),
    ...
    op.create_table('program_approvals',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('program_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_program_approvals_program_id'), 'program_approvals', ['program_id'], unique=False)
