...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            primary_key=True, default=sa.text("gen_random_uuid()"),
        ),
        ...
        sa.Column(
            "status", sa.String(20), nullable=False, default="draft",
        ),
        sa.Column(
            "questions", postgresql.JSON, nullable=False, default={},
        ),
        sa.Column(
            "distribution_method", sa.String(20),
            nullable=False, default="email",
        ),
        sa.Column(
            "reminder_enabled", sa.Boolean,
            nullable=False, default=True,
        ),
        sa.Column(
            "reminder_days", sa.Integer, nullable=False, default=7,
        ),
        sa.Column(
        ...
        sa.Column(
            "closes_at", sa.DateTime(timezone=True), nullable=True,
        ),
        sa.Column(
            "target_client_types", postgresql.JSON, nullable=True,
        ),
        sa.Column(
            "target_client_ids", postgresql.JSON, nullable=True,
        ),
        sa.Column(
        ...
        sa.Column(
            ...
            nullable=False, default=sa.text("now()"),
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("nps_surveys.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "client_profile_id", postgresql.UUID(as_uuid=True),
        ...
        sa.Column(
            "response_channel", sa.String(20),
            nullable=False, default="portal",
        ),
        sa.Column(
            "follow_up_required", sa.Boolean,
            nullable=False, default=False,
        ),
        sa.Column(
            "follow_up_completed", sa.Boolean,
            nullable=False, default=False,
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.ForeignKey("nps_responses.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "client_profile_id", postgresql.UUID(as_uuid=True),
        ...
        sa.Column(
            ...
            nullable=False, default="personal_reach_out",
        ),
    ...
    # Create indexes
    op.create_index(
        "ix_nps_surveys_status", "nps_surveys", ["status"],
    )
    op.create_index(
        "ix_nps_surveys_quarter_year", "nps_surveys",
        ["year", "quarter"],
    )
    op.create_index(
        "ix_nps_responses_survey_id", "nps_responses", ["survey_id"],
    )
    op.create_index(
        "ix_nps_responses_client_profile_id", "nps_responses",
        ["client_profile_id"],
    )
    op.create_index(
        "ix_nps_responses_score_category", "nps_responses",
        ["score_category"],
    )
    op.create_index(
        "ix_nps_follow_ups_survey_id", "nps_follow_ups", ["survey_id"],
    )
    op.create_index(
        "ix_nps_follow_ups_assigned_to", "nps_follow_ups",
        ["assigned_to"],
    )
    op.create_index(
        "ix_nps_follow_ups_status", "nps_follow_ups", ["status"],
    )
    op.create_index(
        "ix_nps_follow_ups_priority", "nps_follow_ups", ["priority"],
    )
...
def downgrade() -> None:
    op.drop_constraint(
        "uq_nps_responses_survey_client", "nps_responses",
        type_="unique",
    )
