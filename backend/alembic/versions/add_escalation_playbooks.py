...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("escalation_paths", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="[]"),
    ...
    op.create_table(
        ...
        sa.Column("step_states", postgresql.JSONB(astext_type=sa.Text()), nullable=False, server_default="[]"),
        sa.Column(
            "started_by",
            postgresql.UUID(as_uuid=True),
