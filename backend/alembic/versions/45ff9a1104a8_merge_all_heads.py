...
down_revision: str | Sequence[str] | None = ('add_api_keys', 'add_calendar_feed_tokens', 'add_deliverable_templates', 'add_partner_webhooks', 'add_portal_feedback', 'add_saved_filters', 'add_table_views', 'add_tax_documents')  # noqa: E501
