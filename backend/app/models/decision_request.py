...
from app.models.enums import DecisionRequestStatus, DecisionResponseType
...
class DecisionRequest(Base, TimestampMixin):
    ...
    response_type: Mapped[DecisionResponseType] = mapped_column(
        String(50), nullable=False, default=DecisionResponseType.choice
    )
    ...
    status: Mapped[DecisionRequestStatus] = mapped_column(
        String(50), nullable=False, default=DecisionRequestStatus.pending
    )
