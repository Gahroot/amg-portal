...
from app.api.v1.partner_capabilities_reviews import router as partner_capabilities_reviews_router
...
router = APIRouter()
router.include_router(partner_capabilities_reviews_router)
