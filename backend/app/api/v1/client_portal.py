...
from app.api.v1.client_portal_profile import _resolve_client_program_ids
from app.api.v1.client_portal_profile import router as client_portal_profile_router
...
router = APIRouter()
router.include_router(client_portal_profile_router)
